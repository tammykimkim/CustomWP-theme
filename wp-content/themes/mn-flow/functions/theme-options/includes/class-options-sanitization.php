...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'mn_flow' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'mn_flow' ),
		'repeat-y'  => __( 'Repeat Vertically', 'mn_flow' ),
		'repeat'    => __( 'Repeat All', 'mn_flow' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'mn_flow' ),
		'top center'    => __( 'Top Center', 'mn_flow' ),
		'top right'     => __( 'Top Right', 'mn_flow' ),
		'center left'   => __( 'Middle Left', 'mn_flow' ),
		'center center' => __( 'Middle Center', 'mn_flow' ),
		'center right'  => __( 'Middle Right', 'mn_flow' ),
		'bottom left'   => __( 'Bottom Left', 'mn_flow' ),
		'bottom center' => __( 'Bottom Center', 'mn_flow' ),
		'bottom right'  => __( 'Bottom Right', 'mn_flow')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'mn_flow' ),
		'fixed'  => __( 'Fixed in Place', 'mn_flow')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'mn_flow' ),
		'italic'      => __( 'Italic', 'mn_flow' ),
		'bold'        => __( 'Bold', 'mn_flow' ),
		'bold italic' => __( 'Bold Italic', 'mn_flow' )
		);
